...
//     const noticeRows = document.querySelectorAll(".program-notice .notice-table tbody tr, .notice-box .notice-table tbody tr"); // 공지사항 행들 (두 가지 경우 모두 선택)
...
//                 const noticeBox = programNotice.querySelector(".notice-box");
//                 const noticeContainer = noticeBox.querySelector(".container");
                
//                 // 모든 공지사항 컨텐츠 표시
//                 if (noticeBox) noticeBox.style.display = "block";
//                 if (noticeContainer) {
//                     // 모든 요소 표시
//                     const allNoticeElements = noticeContainer.querySelectorAll(
//                         ".notice-title, .notice-detail, .boldline, .grayline, .file, .notice-content, .button"
//                     );
//                     allNoticeElements.forEach(el => el.style.display = "block");
//                 }
